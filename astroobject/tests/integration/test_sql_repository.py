...
@pytest.mark.asyncio
async def test_astro_respository_objects_query(
    psql_service, astro_repository: AstroObjectRepository
):
...
@pytest.mark.asyncio
async def test_astro_repository_object_by_id(
    psql_service, astro_repository: AstroObjectRepository
):
...
@pytest.mark.asyncio
async def test_astro_repository_object_is_none(
    psql_service, astro_repository: AstroObjectRepository
):
